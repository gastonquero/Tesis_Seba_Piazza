...
phi.PAM.param.pza400 <- run_quenching_analisis_pzza (dt = PAM.param.pza400, sampling = NULL, protocol = "piazza.400", ppfd.act = 403 )


phi.PAM.param.pza400.2 <- run_quenching_analisis_pzza (dt = PAM.param.pza400.2, sampling = NULL, protocol = "piazza.400.2", ppfd.act = 200 )


phi.PAM.param.pza800 <- run_quenching_analisis_pzza (dt = PAM.param.pza800, sampling = NULL, protocol = "piazza.800", ppfd.act = 1700 )


phi.PAM.param.pza800.2 <- run_quenching_analisis_pzza (dt = PAM.param.pza800.2, sampling = NULL, protocol = "piazza.800.2", ppfd.act = 850 )



phi.PAM.piazzas <- bind_rows (phi.PAM.param.pza400, phi.PAM.param.pza400.2 , phi.PAM.param.pza800 , phi.PAM.param.pza800.2 )



write_delim (phi.PAM.piazzas, file ="./Data/procdata/phi.PAM.piazzas.txt" , 
             delim = ",", na = "NA")
